          ...
          <div className="footer-container-content">
            ...
            <div className="second">
              <div className="app-links">
                <div className="ls-title app-title">Download Our App<TitleLine/></div>
                <img src={android} onClick={()=>_GoToStore("android")} alt="android-store" className="android"/>
                <img src={ios} onClick={()=>_GoToStore("ios")} alt="ios-store"/>
              </div>
            </div>
          </div>
          <div className="copyright">&copy; Copyright 2020. All rights reserved</div>
        </div>
      )
    }
}
